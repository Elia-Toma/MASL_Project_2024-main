...
class Model():
    ...
    def __init__(self, comm: MPI.Intracomm, params: Dict):
        ...
        pygame.init()
        self.screen = GUI(width=1280, height=720, gut_context=self.gut_context, brain_context=self.brain_context, grid_dimensions=(params['world.width'], params['world.height']))
